...
$config['database']['database'] = 'benderao_foro_new';
$config['database']['table_prefix'] = 'mybb_foro_new';

$config['database']['hostname'] = 'localhost';
$config['database']['username'] = 'benderao_foro_new';
$config['database']['password'] = 'ZPBkweWJdV.a';
